// 
// MobeelizerModelCredentialsDefinition.java
// 
...
public class MobeelizerModelCredentialsDefinition implements Serializable {

    private static final long serialVersionUID = -8206514230753148380L;
    ...
    private MobeelizerCredential deleteAllowed;

    private boolean resolveConflictAllowed;

    String getDigestString() {
        return role
                + "="
                + String.format("%d%d%d%d%d", readAllowed.ordinal(), createAllowed.ordinal(), updateAllowed.ordinal(),
                        deleteAllowed.ordinal(), resolveConflictAllowed ? 1 : 0);
    }
    ...
    public void setDeleteAllowed(final MobeelizerCredential deleteAllowed) {
    ...
    public void setResolveConflictAllowed(final boolean resolveConflictAllowed) {
        this.resolveConflictAllowed = resolveConflictAllowed;
    }
